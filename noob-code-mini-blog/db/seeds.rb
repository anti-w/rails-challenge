...
games_post = Post.create(title: 'Elden Ring é pika irmaõ', description: 'Elden Ring vai te deixar maluco e tu vai querer chorar pra tua mãe, mas é gód.', category_id: gamesCategory.id, user_id: jornalist.id)